...
```
wget https://github.com/chartwerk/grafana-chartwerk-app/archive/0.3.0.zip
```
...
docker run \
  -p 3000:3000 \
  -e "GF_INSTALL_PLUGINS=https://github.com/chartwerk/grafana-chartwerk-app/archive/0.3.0.zip;corpglory-chartwerk-panel" \
  grafana/grafana
```
