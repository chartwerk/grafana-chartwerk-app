...
```
wget https://github.com/chartwerk/grafana-chartwerk-app/archive/0.3.1.zip
```
...
docker run \
  -p 3000:3000 \
  -e "GF_INSTALL_PLUGINS=https://github.com/chartwerk/grafana-chartwerk-app/archive/0.3.1.zip;corpglory-chartwerk-panel" \
  grafana/grafana
```
